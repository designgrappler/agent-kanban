...
| S16-T2 | Backlog tab UI + planning trigger — new `/boards/:id/backlog` route, priority-grouped list, multi-select, **Create plan** clipboard handoff per `north-star.md § Planning Trigger Flow`. DESIGN.md compliance required | Code close-gate | Skylar (worktree) | In progress — Skylar implementing 2026-05-23 |
