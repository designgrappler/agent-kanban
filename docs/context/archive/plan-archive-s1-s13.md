# Sprint Archive — Sprints S1 through S13

This file contains the historical sprint plan sections (Sprint 4 through Sprint 13, plus pre-sprint content) verbatim as they appeared in `docs/context/plan.md` before the S15-T2 context migration on 2026-05-23. These sections have been removed from the live `plan.md` to keep the active context lean (current sprint only). Sprint 14 is archived separately at `docs/context/archive/plan-s14-diagnostic.md`. This archive is a permanent record; do not edit it.
